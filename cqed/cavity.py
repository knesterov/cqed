...
class Cavity(object):
    ...
    omega : float
        Cavity frequency.
    nlev : int, default=20
        The number of cavity states.
    """

    def __init__(self, omega, nlev=20):
    ...
    def __str__(self):
        s = ('A resonator with frequency = {} '.format(self.omega))
        return s

    def level(self, level_ind):
        """Energy of a single cavity level.
    ...
    def a_ij(self, level1, level2):
        """The annihilation operator matrix element.
